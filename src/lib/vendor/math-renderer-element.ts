...
const MATHJAX_PREFIX_REGEX = /^(TEX|mjx|MJX)-/;
      ...
      startup: {
        ...
        ready() {
          ...
          if (safe) {
            ...
            safe.filterMethods.filterSemiColon = (_: unknown, input: string) => {
...
function allowMathMlAttributes(
  el: Element,
  data /*: Dompurify.UponSanitizeAttributeHookEvent*/
): void {
